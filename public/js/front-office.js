...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      /* questo ci darà gli oggetti che ritorniamo da postman */
      pagination: null
    };
  },
  ...
  methods: {
    getPosts: function getPosts() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("http://127.0.0.1:8000/api/posts?page=".concat(page)).then(function (res) {
        console.log(res); // A. dati non impaginato (si trovano solo in console)
        // qui si trova il dato effettivo

        /*  this.posts = res.data.data; */
        // B. dati impaginato

        _this.posts = res.data.data; // C. paginazioni
              ...
              _vm._l(_vm.posts, function (post) {
                return _c(
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _c("p", [_vm._v(_vm._s(_vm.getExcerpt(post.body, 100)))]),
                  ]
                )
              }),
              _vm._v(" "),
...
var root = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: '#root',
  // nodo che usciamo per interagire (riga 14 file home blade.php in cartella guests)
  render: function render(h) {
...
module.exports = __webpack_require__(/*! C:\Users\Aleva\Desktop\Boolean class 45\Laravel\Laravel-Boolpress\resources\js\front-office.js */"./resources/js/front-office.js");
